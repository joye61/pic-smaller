...
const localeData: LocaleData = {
  ...
  optionPannel: {
    ...
    qualityTitle:
      "Установите качество сжатия (0-100): чем больше значение, тем больше будет создаваемое изображение",
    resetBtn: "перезагрузить",
    confirmBtn: "Конечно",
    enableHighPng: "Включить высококачественное сжатие типа PNG",
    highPngDither:
      "Установите коэффициент дизеринга (0-100): чем больше значение, тем больше шума, но тем более плавное изображение",
  },
  error404: {
